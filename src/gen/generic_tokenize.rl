...
#include "generic_suffix_match.ic"

%%{

machine tokenize_generic;
...
include word "generic_word.rl";
include generic_lexicon "generic_lexicon.rl";
...
main := |*
   ...
   generic_lexicon  => { SAVE(MR_LATIN); fbreak; };
